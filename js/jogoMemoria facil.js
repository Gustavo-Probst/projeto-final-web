...
const pares = {
  ...
  "resp-facil(3)": "facil(3)",
  "facil(3)": "resp-facil(3)",
  "resp-facil(4)": "facil(4)",
  "facil(4)": "resp-facil(4)",
  "resp-facil(5)": "facil(5)",
  "facil(5)": "resp-facil(5)",
};
...
const criarCard = (conteudo) => {
  ...
  frente.style.backgroundImage = `url(./imagens/${conteudo}.png)`;
